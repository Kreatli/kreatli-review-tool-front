...
export const PdfAnnotatorGuide = () => {
  const workflowSteps: Array<{
  ...
  }> = [
    {
      ...
      description:
        'Upload your PDF to a Kreatli project. Your file is stored with version history so you can annotate and share for review in one place.',
      icon: 'upload',
      image: `${IMG}-1.webp`,
    ...
    },
    {
      ...
      altText: 'Kreatli Media view with PDF in project, open for annotation',
      imageClassName: 'max-w-4xl',
    },
    {
      step: 3,
    ...
    <div>
                    ...
                    {item.image && (
                      <div className="mt-6 flex justify-center lg:mt-8">
                        <div className="relative max-w-full">
                          <Image
                            src={item.image}
                            alt={item.altText || `${item.title} - PDF annotator screenshot`}
                            loading="lazy"
                            removeWrapper
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardBody className="p-6">
                ...
                <p className="text-foreground-500">
                  Pin comments to exact spots on a page. Use highlights, shapes, arrows, and freehand drawing to mark
                  regions and point to elements so designers and writers know precisely what to change.
                </p>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardBody className="p-6">
                ...
                <p className="text-foreground-500">
                  Share secure links so clients and stakeholders can open the PDF, add comments and markup, and submit
            ...
            <Card>
              <CardBody className="p-6">
                ...
                <p className="text-foreground-500">
                  Multiple people can annotate the same PDF. Each person’s comments and markup are visible to everyone,
                  with indicators for who added what. Filter by reviewer and consolidate feedback in one place.
                </p>
              </CardBody>
            </Card>
          </div>
      ...
      <section className="relative overflow-hidden bg-foreground-50 px-6 py-12">
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <h2 className="mb-4 font-sans text-2xl font-bold sm:text-3xl">Explore PDF Annotation in Kreatli</h2>
          <p className="mx-auto mb-6 max-w-2xl text-lg text-foreground-500">
            Learn more about annotating PDFs, drawing on PDFs, and review workflows.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button as={NextLink} href="/platform/annotate-pdf" size="lg" className="bg-foreground text-content1">
              Annotate PDF
            </Button>
            <Button as={NextLink} href="/platform/draw-on-pdf-document" size="lg" variant="bordered">
              Draw on PDF
            </Button>
          </div>
        </div>

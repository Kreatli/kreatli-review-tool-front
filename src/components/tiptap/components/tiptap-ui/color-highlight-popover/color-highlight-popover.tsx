...
// --- Tiptap UI ---
import type { HighlightColor, UseColorHighlightConfig } from '../../tiptap-ui/color-highlight-button';
import {
...
export const ColorHighlightPopoverButton = forwardRef<
  HTMLButtonElement,
  ButtonProps & Pick<UseColorHighlightConfig, 'editor'>
>(({ className, children, editor: providedEditor, ...props }, ref) => {
  const { editor } = useTiptapEditor(providedEditor);

  const [isVisible, setIsVisible] = useState(editor?.isEditable);

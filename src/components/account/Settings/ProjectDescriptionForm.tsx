...
interface Props {
  defaultProjectContent: SettingsDto['defaultProjectContent'];
}

export const ProjectDescriptionForm = ({ defaultProjectContent }: Props) => {
  ...
  return (
    <div className="flex flex-col gap-4 pt-4">
      <div className="flex w-full flex-col gap-2">
        ...
        >
          <SimpleEditor content={defaultProjectContent} editorRef={editorRef} isEditable onUpdate={handleUpdate} />
        </div>
      </div>

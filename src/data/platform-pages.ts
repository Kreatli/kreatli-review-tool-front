...
export const PLATFORM_PAGES: PlatformPage[] = [
  ...
  },
  {
    ...
    description: 'Highlight text and regions in PDFs for review',
    icon: 'filePdf',
    section: 'Core Platform',
    order: 23,
    tags: ['PDF & documents', 'Review & compare'],
    ...
    relatedResourceKeys: ['reviewApproval', 'creativeProofing', 'annotatePdf', 'addCommentsToPdf', 'drawOnPdfDocument'],
  },
  {
  ...
  },
  {
    ...
    href: '/platform/download-tiktok-video',
    description: 'Download TikTok video from a public link (MP4)',
    icon: 'tiktok',
    section: 'Core Platform',
    order: 28.65,
    tags: ['Video', 'Share & send'],
  ...
  {
    label: 'Picture into URL',
    href: '/platform/picture-into-url',
    description: 'Turn your picture into a shareable URL for secure review and feedback',
    icon: 'link',
    section: 'Core Platform',
    order: 36,
    tags: ['Review & compare', 'Share & send'],
  ...
  },
  {
    ...
    description: 'Review PDF files with comments, annotations, and approvals',
    icon: 'filePdf',
    section: 'Core Platform',
    order: 37,
    tags: ['PDF & documents', 'Review & compare'],
  ...
  },
  {
    ...
    description: 'Proof PDF files with comments, annotations, and approvals',
    icon: 'filePdf',
    section: 'Core Platform',
    order: 38,
    tags: ['PDF & documents', 'Review & compare'],
  ...
  },
  {
    ...
    description: 'Review video with frame-accurate comments, annotations, and approvals',
    icon: 'monitorPlay',
    section: 'Core Platform',
    order: 39,
    tags: ['Video', 'Review & compare'],
  ...
  {
    label: 'Video Proofing',
    href: '/platform/video-proofing',
    description: 'Video proofing with frame-accurate comments, annotations, and approvals',
    icon: 'checkCircle',
    section: 'Core Platform',
    order: 40,
    tags: ['Video', 'Review & compare'],
  ...
  },
  {
    ...
    description: 'Manage videos with version control, feedback tracking, and approvals',
    icon: 'folder',
    section: 'Core Platform',
    order: 41,
    tags: ['Video', 'Review & compare'],
  ...
  {
    label: 'Video Cloud Storage',
    href: '/platform/video-cloud-storage',
    description: 'Video cloud storage with version history and review tools',
    icon: 'monitorPlay',
    section: 'Storage & Integrations',
    order: 1.5,
    tags: ['Video'],
    ...
    relatedResourceKeys: ['secureAssetStorage', 'creativeWorkspace', 'projectOrchestration'],
  },
  {
    label: 'File Cloud Storage',
    href: '/platform/file-cloud-storage',
    description: 'File cloud storage for all your creative assets',
    icon: 'folder',
    section: 'Storage & Integrations',
    order: 1.75,
    sitemap: {
  ...
  {
    label: 'Cloud Sharing',
    href: '/platform/cloud-sharing',
    description: 'Cloud sharing for secure, link-based review',
    icon: 'share',
    section: 'Storage & Integrations',
    order: 1.85,
    tags: ['Share & send'],

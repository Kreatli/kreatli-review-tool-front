  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Kreatli | Safe Zone Checker - Preview Content for TikTok, Instagram Reels & YouTube Shorts"
        />
        <meta
      ...
      <section className="relative py-16 px-6 backdrop-blur-lg overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold font-sans mb-4">What are Safe Zones and Why They Matter</h2>
          ...
          <Card className="bg-foreground-50">
            <CardBody className="p-6 lg:p-8">
              <h3 className="text-xl font-bold font-sans mb-4">The Impact of Safe Zones</h3>
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <Icon icon="cross" size={18} className="text-warning" />
                    Without Safe Zones
                  </h4>
                  <ul className="space-y-2 text-foreground-500 text-sm">
                    <li>• Titles hidden behind UI overlays</li>
                    <li>• Logos cropped or obscured</li>
                    <li>• CTAs invisible to viewers</li>
                    <li>• Reduced engagement and clarity</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <Icon icon="check" size={18} className="text-success" />
                    With Safe Zones
                  </h4>
                  <ul className="space-y-2 text-foreground-500 text-sm">
                    <li>• All critical content remains visible</li>
              ...
              <CardBody className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-danger/10 rounded-full p-2">
                    <Icon icon="addVideo" size={20} className="text-danger" />
                  </div>
              ...
              <CardBody className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-warning/10 rounded-full p-2">
                    <Icon icon="addVideo" size={20} className="text-warning" />
                  </div>
      ...
      <section className="relative py-16 px-6 backdrop-blur-lg overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold font-sans mb-4">
              How to Use Safe-Zone Checker Templates in Your Workflow
            </h2>
            <p className="text-lg text-foreground-500 max-w-3xl mx-auto">
              ...
              <Card key={item.step} className="scroll-mt-36">
                <CardBody className="p-6 lg:p-8">
                  <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="lg:w-3/4 lg:pl-8 lg:border-l border-foreground-200">
      ...
      <section className="relative py-16 px-6 backdrop-blur-lg overflow-hidden">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold font-sans mb-4">Validation Checklist Before Export</h2>
            <p className="text-lg text-foreground-500 max-w-3xl mx-auto">
              Run through this checklist before marking your video as final to ensure everything looks perfect.
            </p>
          </div>
            ...
            <CardBody className="p-6 lg:p-8">
              <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={index} className="flex items-start gap-3 text-foreground-500">
                        <div className="size-6 bg-success/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {[
                      'For ads or branded videos: overlay safe-zone rules applied',
                      'UI overlays not overlapping key content',
                      'Text readable on small screens',
                      'Platform-specific requirements met',
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-3 text-foreground-500">
                        <div className="size-6 bg-warning/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <Icon icon="warning" size={14} className="text-warning" />
                        </div>
                        <span>{item}</span>
                      </li>
                    ))}
              ...
              <div className="mt-6 p-4 bg-warning/5 rounded-lg border border-warning/20">
                <p className="text-sm text-foreground-600">
                  <strong>Remember:</strong> Text and branding outside safe zones leads to missed CTAs, unclear
                  messages, and avoidable rework - especially on small screens or when platforms render differently.
                </p>
              </div>
            </CardBody>
          </Card>
      ...
      <section className="bg-foreground-50 lg:py-24 py-16 px-6 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-6 relative z-10">
          ...
          <p className="text-sm text-foreground-500 mt-4">
            ...
            >
              Read our complete safe zone guide →
            </a>
          </p>
        </div>
      </section>

...
const additionalFeatures = [
  {
    ...
    description: 'Organize files by project, status, type, and more. Powerful filtering and search help you find what you need instantly.',
  },
  {
    icon: 'link',
    title: 'Secure Guest Links',
    description: 'Share review links with clients and collaborators without requiring signups. Password protection and access controls included.',
  },
  {
    icon: 'share',
    title: 'Version History',
    description: 'Track all changes with comprehensive version history. Never lose your work and easily revert to previous versions.',
  },
  {
    icon: 'checkShield',
    title: 'Enterprise Security',
    description: 'Bank-level encryption, secure file sharing, and compliance-ready security features for sensitive creative work.',
  },
  {
    icon: 'upload',
  ...
  },
  {
    ...
    description: 'Get instant alerts for comments, approvals, and project updates. Stay in sync without constant checking.',
  },
];
      ...
      <div className="border-t border-foreground-200">
        ...
        <section className="bg-foreground-50 lg:py-24 py-16 px-6">
          <div className="max-w-4xl mx-auto text-center flex flex-col gap-6">
            <h1 className="text-3xl sm:text-5xl font-bold font-sans">Features</h1>
            <p className="text-lg sm:text-xl text-foreground-500 max-w-2xl mx-auto">
              Kreatli offers functionality creative teams actually need. Frame-accurate revisions, conversations tied to
              assets, and project management all in one place. No unnecessary features.
            </p>
              ...
              <CardBody className="p-0 overflow-x-auto">
                <Table aria-label="Feature comparison table" removeWrapper>
                  <TableHeader>
                    ...
                    <TableColumn>Frame.io</TableColumn>
                    <TableColumn>Slack + Tools</TableColumn>

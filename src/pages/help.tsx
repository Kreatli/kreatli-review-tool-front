...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Choosing the right plan depends on your team size and storage needs. All plans include unlimited projects and a 7-day free trial. To start the trial, you'll add a payment method at secure checkout, and you won't be charged subscription fees during the trial.\n\nThe Creator plan ($14/user/month, up to 3 members, 500GB storage) is perfect for solo creators and small teams who want unlimited projects and need basic collaboration features.\n\nThe Team plan ($29/user/month, up to 10 members, 2TB storage) is ideal for established teams running multiple projects with shared assets, structured reviews, and consistent workflows. This plan works well for micro-teams, freelance teams, and small agencies that need more capacity and collaboration features.\n\nThe Enterprise plan (custom pricing) provides custom members, custom storage, Single Sign-On (SSO), a dedicated account manager, and custom integrations. This plan is suitable for larger agencies, post-production houses, and organizations that need advanced controls and dedicated support. If you're unsure which plan is right for your team, start with a 7-day trial and our support team can help you evaluate which plan best fits your video collaboration requirements.",
  },
  {
    ...
    <>
      ...
      <section className="relative overflow-hidden px-6 py-16">
        <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-6 text-center">
          <h1 className="mx-auto max-w-lg font-sans text-3xl font-bold sm:text-4xl">Help Center</h1>
        ...
        <section className="relative overflow-hidden px-6 py-16 backdrop-blur-lg">
          <div className="relative z-10 mx-auto max-w-6xl">
            <div className="mb-8 text-center">
              <h2 className="mb-4 font-sans text-2xl font-bold sm:text-3xl">Popular Questions</h2>
              <p className="mx-auto max-w-2xl text-lg text-foreground-500">

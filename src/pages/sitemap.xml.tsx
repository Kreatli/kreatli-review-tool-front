...
const STATIC_PAGES: StaticPage[] = [
  ...
  { path: '/free-tools/video-frame-rate-converter', priority: '0.8', changefreq: 'weekly' },
  ...
  { path: '/free-tools/pdf-highlighter', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/pdf-comparer', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/pdf-link-generator', priority: '0.8', changefreq: 'weekly' },
  ...
  { path: '/free-tools/image-markup-tool', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/image-comparer', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/image-url-maker', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/photo-url-generator', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/document-annotator', priority: '0.8', changefreq: 'weekly' },
  { path: '/free-tools/document-comparer', priority: '0.8', changefreq: 'weekly' },
  ...
  { path: '/free-tools/video-markup-tool', priority: '0.8', changefreq: 'weekly' },
  ...
  { path: '/safe-zone-checker', priority: '0.7', changefreq: 'monthly' },
  { path: '/safe-zone-checker/instagram-safe-zone-checker', priority: '0.7', changefreq: 'monthly' },
  { path: '/safe-zone-checker/tiktok-safe-zone-checker', priority: '0.7', changefreq: 'monthly' },
  { path: '/safe-zone-checker/youtube-safe-zone-checker', priority: '0.7', changefreq: 'monthly' },

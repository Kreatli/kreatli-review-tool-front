...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Kreatli uses industry-standard encryption to protect your files. Files are encrypted at rest (when stored) and in transit (when uploaded or downloaded). This means your creative assets are protected from unauthorized access at every stage. The encryption is enterprise-grade, meeting security standards required for handling sensitive creative work. Even if someone were to gain access to the storage infrastructure, encrypted files would remain protected. This level of security is essential for agencies and production studios working with confidential client materials.',
  },
  {
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="mx-auto mt-12 flex max-w-3xl flex-col items-center gap-4 text-center">
            ...
            <p className="text-foreground-500">
              ...
              to learn how Kreatli's secure asset storage can help protect your creative assets.
            </p>
          </div>
        </div>
      </section>

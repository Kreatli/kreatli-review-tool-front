        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="mb-8 text-center">
            <h2 className="mb-4 font-sans text-2xl font-bold sm:text-3xl">
              Extract, Get & Export Frames—Built for Creative Teams
            </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardBody className="p-6">
                ...
                <p className="text-sm text-foreground-500">
                  Use the Video Frame Extractor without creating an account. Upload or drag your video, capture
                  frames, and download—ideal for quick thumbnails, proofs, or keyframe approval.
                </p>
              </CardBody>
            </Card>
      ...
      <section className="relative overflow-hidden px-6 py-16">
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-foreground-500">
              Still frames make it easy to get approval on specific moments, create thumbnails, and give
              frame-accurate feedback without sending full video files.
            </p>
          </div>

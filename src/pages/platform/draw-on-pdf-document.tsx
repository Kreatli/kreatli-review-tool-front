...
import { DRAW_ON_PDF_DOCUMENT_STEPS, PlatformStepGuide } from '../../components/shared/PlatformStepGuide';
...
export default function DrawOnPdfDocumentPage() {
  ...
  return (
    <>
      ...
      <PlatformDefinitionBlock href="/platform/draw-on-pdf-document" />
      <PlatformStepGuide

...
export default function AnnotatePdfPage() {
  ...
  return (
    <>
      <Head>
        <title>PDF Annotation for Creative Teams | Kreatli Platform</title>
        <meta
          name="description"
          content="Annotate PDFs with comments, drawings, and markup. Keep feedback tied to projects and versions in one workspace."
        />
        ...
        <meta property="og:title" content="PDF Annotation for Creative Teams | Kreatli Platform" />
        <meta
        ...
        <meta property="og:image:alt" content="PDF Annotation for Creative Teams | Kreatli Platform" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="PDF Annotation for Creative Teams | Kreatli Platform" />
        <meta
      ...
      <PlatformDefinitionBlock href="/platform/annotate-pdf" />
      <PlatformStepGuide
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="mx-auto w-fit max-w-full rounded-2xl border border-foreground-200 bg-content1/60 px-6 py-8 shadow-sm backdrop-blur-sm">
            ...
            <p className="mx-auto mt-2 max-w-xl text-center text-sm text-foreground-500">
              Need to highlight pdf, comments only, or draw directly on PDFs? Explore these options:
            </p>

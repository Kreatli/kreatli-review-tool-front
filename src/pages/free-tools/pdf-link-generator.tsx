...
export default function PdfLinkGeneratorPage() {
  useSession();
...
<meta property="og:title" content="Turn a PDF into a Link – Free PDF Link Generator | Kreatli" />
      ...
      <main id="main-content">
        ...
        <PlatformStepGuide
          ...
          stepsIntro="Follow these steps to upload your PDF, generate a shareable link, and collect feedback—recipients do not need a Kreatli account. Sign in to create links; start a trial or choose a plan if your subscription isn’t active."
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-foreground-500">
                Learn how the PDF link generator works and how it fits into your review and approval workflows.
              </p>
            </div>
            <Accordion variant="splitted" aria-label="PDF link generator FAQs" className="gap-2">
              {faqs.map((faq) => (
                <AccordionItem
                  key={faq.question}
        ...
        <RelatedResourcesSection
          ...
          description="Explore other Kreatli platform features for PDF review, annotation, and collaboration."
        />

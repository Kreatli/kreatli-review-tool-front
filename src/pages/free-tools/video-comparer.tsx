        ...
        <section className="relative overflow-hidden px-6 py-16">
          <div className="relative z-10 mx-auto max-w-6xl">
            ...
            <FreeToolsEntitlementSection
              lockedTitle="Video Comparer is available inside Kreatli"
              lockedDescription="Your trial or plan isn’t active. Start a trial or choose a plan to compare video versions in Kreatli."
            >

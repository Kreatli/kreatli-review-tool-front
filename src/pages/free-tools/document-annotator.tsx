  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Free online document annotator for creative teams. Add location-pinned comments, highlights, drawings, and markup to documents (e.g. PDFs). Share with clients—no sign-up required for reviewers."
        />
        <meta
          name="keywords"

    ...
    <>
      ...
      <main id="main-content">
        ...
        <section className="relative overflow-hidden px-6 py-16">
          <div className="relative z-10 mx-auto max-w-6xl">
            ...
            <FreeToolsEntitlementSection
              ...
              lockedDescription="Your trial or plan isn’t active. Start a trial or choose a plan to generate secure image review URLs in Kreatli."
            >
        ...
        <DefinitionBlock term="Image URL Maker">
          An image URL maker creates a shareable link to an image file so collaborators can open it in the browser
          without email attachments. Teams use it to route assets into review, collect comments, and keep a single
          source of truth for the latest image.
        </DefinitionBlock>
        {/* How to turn your image into a link guide */}
        <PlatformStepGuide
          stepsSectionTitle="How to turn your image into a link in Kreatli"
          stepsIntro="Follow these steps to upload your image, generate a shareable link, and collect feedback—recipients do not need a Kreatli account. Sign in to create links; start a trial or choose a plan if your subscription isn’t active."

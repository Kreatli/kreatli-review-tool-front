...
export default function PdfReviewerPage() {
  useSession();
    ...
    <>
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: 'PDF Reviewer', url: '/free-tools/pdf-reviewer' },
        ]}
      />
      <FAQStructuredData faqs={pdfReviewerFaqs} />
      <Header />
      <Decorations />
      ...
      <main id="main-content">
        ...
        <section className="relative overflow-hidden px-6 pb-4 pt-16">
          <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-6 text-center">
            <h1 className="mx-auto max-w-lg font-sans text-3xl font-bold sm:text-4xl">PDF Reviewer</h1>
            <p className="mx-auto max-w-3xl text-lg text-foreground-500">
              Review PDFs online with location-pinned comments, visual annotations, and approval workflows. Collect
        ...
        <RelatedResourcesSection
          resources={getRelatedResources(['annotatePdf', 'addCommentsToPdf', 'clientApprovals', 'creativeProofing'])}
          title="More Resources"
          description="Learn more about PDF review workflows, annotations, and team collaboration."
        />

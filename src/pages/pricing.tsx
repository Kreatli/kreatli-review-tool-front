      ...
      <div className="border-t border-foreground-200">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              ...
              <Card className="border border-foreground-300">
                <CardBody className="p-6">
                  ...
                  <p className="text-foreground-500 text-sm">
                    Powerful annotation tools for precise feedback on images, videos, and documents. Perfect for design
                    reviews.
                  </p>
                </CardBody>
              </Card>
        ...
        <section className="py-16 px-6 bg-foreground-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-4xl font-bold font-sans text-center mb-12">

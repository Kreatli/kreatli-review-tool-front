...
const faqs = [
  {
    ...
    answer:
      "Yes! You can upgrade or downgrade your plan at any time to match your evolving needs. If you need more projects, users, or features, you can upgrade your plan immediately and gain access to the additional capabilities right away. If you find you're not using all the features of your current plan, you can downgrade to a more cost-effective option. When you upgrade, you'll be charged a prorated amount for the remainder of your current billing cycle, and then the new plan price will apply going forward. When you downgrade, the changes will take effect at the start of your next billing cycle, giving you time to adjust your usage. This flexibility ensures you're only paying for what you need while having the option to scale up when your video collaboration requirements grow. All plan changes are handled through your account settings, and you'll receive email confirmation of any changes. There are no fees for changing plans, and you can switch as often as needed. This makes it easy to adapt your Kreatli subscription to match your team's current size and needs without being locked into a plan that doesn't fit.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! For teams with specific needs, we offer custom enterprise plans with dedicated support, custom integrations, advanced features, and tailored pricing. Enterprise plans are designed for large agencies, post-production houses, and organizations that need specialized features or support beyond what's available in standard plans. Enterprise plans typically include dedicated account management, priority support, custom integrations with your existing tools, advanced security features, custom storage limits, and specialized training for your team. We work with enterprise clients to understand their specific video collaboration needs and tailor the solution accordingly. Enterprise plans also often include features like single sign-on (SSO), advanced analytics and reporting, custom branding options, and service level agreements (SLAs) for uptime and support response times. If you're interested in an enterprise plan, contact our sales team to discuss your requirements and get a customized proposal that fits your organization's needs and budget.",
  },
  {
    question: 'Do you offer annual billing, and are there discounts for annual plans?',
    answer:
      "Yes, Kreatli offers annual billing options with discounts compared to monthly billing. Annual plans provide cost savings (typically 10-20% off monthly pricing) and simplify budgeting by requiring one payment per year instead of 12 monthly payments. This makes annual billing attractive for teams committed to using Kreatli for their video collaboration. When you choose annual billing, you're charged upfront for the entire year, and your subscription automatically renews annually unless you cancel. The discount on annual plans reflects the commitment and reduces administrative overhead for both you and Kreatli. You can switch between monthly and annual billing at any time, though the discount only applies when you're on an annual plan. Annual billing is available for all paid plans (Creator, Team, and Enterprise), and you can upgrade or downgrade even when on an annual plan. If you upgrade mid-year, you'll be charged a prorated amount for the remainder of your annual billing cycle. This flexibility ensures annual billing works for teams that want to save money while maintaining the ability to adjust their plan as needed.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Kreatli offers a satisfaction guarantee for new paid subscriptions. If you're not satisfied with Kreatli within the first 30 days of your paid plan, you can request a full refund. This gives you time to evaluate the platform with your full team and see how it improves your video collaboration workflow. After the initial 30-day period, refunds are handled on a case-by-case basis. Since Kreatli uses monthly or annual billing, you can cancel at any time and won't be charged for future billing cycles. If you cancel mid-cycle, you'll retain access until the end of your current billing period, so you're not paying for time you're not using. For annual plans, if you cancel mid-year, you'll retain access until the end of your annual billing period. Refunds for unused portions of annual plans are evaluated on a case-by-case basis, typically considering how much of the year has passed and the specific circumstances. Our support team can help you understand your options if you need to cancel an annual plan early.",
  },
];
      ...
      <section className="relative overflow-hidden px-6 py-16 backdrop-blur-lg">
        <div className="relative z-10 mx-auto max-w-6xl">
          <div className="mb-4 text-center">
            <h2 className="mb-4 font-sans text-2xl font-bold sm:text-3xl">Why Kreatli's Pricing Works for You</h2>
            <p className="mx-auto max-w-2xl text-lg text-foreground-500">

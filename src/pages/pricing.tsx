        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <Accordion variant="splitted">
            ...
            <AccordionItem
              key="cancel-data"
              title={
                <span className="font-semibold text-base">What happens to my data if I cancel my subscription?</span>
              }
            >
              <div className="text-foreground-500 space-y-3">
                <p>
          ...
          <div className="max-w-3xl mx-auto flex flex-col gap-4 text-center items-center mt-8">
            <h3 className="text-xl font-sans font-bold">Still Have Questions About Pricing?</h3>
